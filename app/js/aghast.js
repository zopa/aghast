...
function jsmain() {
    ...
    phonecatApp.controller('PhoneListCtrl', Haste.listPhones);
}
...
var _0=0,_1=unCStr("(function(s, f) {  Haste[s] = function() {      var args = Array.prototype.slice.call(arguments,0);      args.push(0);      return E(A(f, args));    };  return 0;})"),_2=new T(function(){return E(0);}),_3=new T(function(){return [0,"phones"];}),_4=unCStr("function(o,p,v){o.p = v};"),_5=function(_6){var _7=A(_6,[_]);return E(_7);},_8=function(_9){return _5(function(_){var _=0;return eval(toJSStr(E(_9)));});},_a=new T(function(){return _8(_4);}),_b=new T(function(){return [0,"[{\'name\': \'Nexus S\', \'snippet\': \'Fast, says google\'},{\'name\': \'XOOM\', \'snippet\': \'Tablet propaganda\'}]"];}),_c=function(_d,_){var _e=String(_d),_f=A(_a,[E(_e),E(E(_3)[1]),E(E(_b)[1]),_]);return _2;},_g=unCStr("phoneList"),_h=function(_){var _i=A(_8,[_1,E(toJSStr(E(_g))),_c,_]);return _0;},_j=function(_){return _h(_);};
var hasteMain = function() {A(_j, [0]);};hasteMain(); jsmain();